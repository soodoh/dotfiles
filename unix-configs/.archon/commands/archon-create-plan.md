...
**Exploration Strategy**: Perform a dedicated codebase intelligence pass before any external research. Use the tools available in this provider to gather thorough pattern evidence.
...
**CRITICAL: Perform a very thorough codebase exploration pass before designing the solution.**

### 2.1 Run Codebase Exploration
...
1. **What primitives already exist?** List the core abstractions in the codebase
   related to this feature — with file:line references from the codebase exploration output.
...
- {Pattern 1 from codebase exploration with file:line}
- {Pattern 2 from codebase exploration with file:line}
- {Pattern 3 from codebase exploration with file:line}
...
- **CONTEXT_COMPLETE**: All patterns, gotchas, integration points documented from actual codebase exploration
