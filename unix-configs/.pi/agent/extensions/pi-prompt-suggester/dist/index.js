    ...
    const adapter = new PiExtensionAdapter(pi, {
        ...
        onStatusCommand: async (ctx) => {
            ...
            pi.sendMessage({
                ...
                content: renderStatus(seed, state, effectiveConfig, ctx, composition.stores.variantStore.getActiveVariantName()),
                display: true,
            }, { triggerTurn: false });
        },
